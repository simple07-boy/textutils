// type rfc and we will get default code 
...
export default function Navbar(props) {
    return (
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            {/* Using dark then you replace light to dark */}
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        {/* We write 'link' in place of "a" and 'to' in place of "href". */}
                        <li className="nav-item">
                    ...
                    {/* <form className="d-flex">
                        ...
                        // Beside from success we also use danger and primary to change the color from green to red and blue
                    </form> */}
